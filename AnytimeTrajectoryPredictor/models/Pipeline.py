...
if __name__ == "__main__":
    ...
    # Data setup
    path_to_local_images = "/Users/nathangromb/Documents/MA4/VI/project/data/waymo/images.parquet"
    ...
    model_args = Box({
        "feature_extractor": Box({
            "features": [None] * 391, # Matches the dim of the FE output features
        }),
        "model": Box({
    ...
    feature_extractor_args = {
        "feature_components": ["bboxes", "confidences", "object_ids", "class_ids", "latent_features", "local_latent_features"],
        "imgsz": 640,
        "verbose": False
    }
    ...
    print(f"Output: {len(output)} timestep of shape {tuple(set(t.shape for t in output))} - (B, N, {num_trajectory_possibilities}, 11)")
