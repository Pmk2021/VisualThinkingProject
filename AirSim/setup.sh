...
singularity pull airsim.sif docker://nathangromb/airsim_binary:11.4.2-cudagl-ubuntu20.04

# Setup UE Blocks test environment
mkdir -p /home/$USER/airsim_test/
cd /home/$USER/airsim_test
wget https://github.com/microsoft/AirSim/releases/download/v1.3.0-linux/Blocks.zip
unzip Blocks.zip
rm Blocks.zip
chmod +x /home/$USER/airsim_test/LinuxBlocks1.8.1/LinuxNoEditor/Blocks.sh
...
conda create -n airsimtest python=3.10 -y
...
singularity exec --nv \
  ...
  /app/Blocks.sh -opengl4 -windowed -ResX=640 -ResY=480 -noaudio -novideo -nohmd -noxr
